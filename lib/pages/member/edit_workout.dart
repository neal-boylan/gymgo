...
class EditWorkout extends StatefulWidget {
  final String docId;
  const EditWorkout({super.key, required this.docId});

  @override
  State<EditWorkout> createState() => _EditWorkoutState(docId);
}

class _EditWorkoutState extends State<EditWorkout> {
  final String docId;
  _EditWorkoutState(this.docId);
  ...
  Future<void> createWorkout() async {
    try {
      ...
      editWorkoutInDb(userCredential);
  ...
  Future<void> editWorkoutInDb(String? userId) async {
    try {
